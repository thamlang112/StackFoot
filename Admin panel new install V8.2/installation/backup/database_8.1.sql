...
--
-- Host: localhost
-- Generation Time: Mar 16, 2025 at 08:01 AM
...
CREATE TABLE `restaurant_configs` (
  ...
  `schedule_advance_dine_in_booking_duration` int(11) NOT NULL DEFAULT 0,
  `schedule_advance_dine_in_booking_duration_time_format` varchar(10) NOT NULL DEFAULT 'min'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
